...
namespace TerseLang {
    ...
    public static class Constants {
        ...
        public const string UNARY_FUNCTIONS = "太该当经妈用打地再因呢女告最手前找行快而死先像等被从明中诉";
        ...
        public const string VARIABLES = "哦情作跟面爱已之问错孩斯成它感干法电间";
        public const string PARAMETER_VARIABLES = "斯成它感干法";
        public const string INPUT_VARIABLES = "哦情作跟";

        public const char IF = '?';

        public const string USAGE = "Usage: terse [-f path|-p program] [inputs...]\n" + 
