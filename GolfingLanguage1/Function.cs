...
namespace TerseLang {
    public abstract class Function {
        ...
        private static readonly ReadOnlyCollection<(String name, Function function)> Functions = new ReadOnlyCollection<(String name, Function function)>(new List<(String name, Function function)> {
			...
			//Function "家", Binary (Number, Number)
			//
			("家", new BinaryFunction<double,double>((x,y) => x)),

			//Function "后", Binary (Number, Number)
			//
			("后", new BinaryFunction<double,double>((x,y) => x)),

			//Function "儿", Binary (Number, Number)
			//
			("儿", new BinaryFunction<double,double>((x,y) => x)),

			//Function "多", Binary (Number, Number)
			//
			("多", new BinaryFunction<double,double>((x,y) => x)),

			//Function "意", Binary (Number, Number)
			//
			("意", new BinaryFunction<double,double>((x,y) => x)),

			//Function "别", Binary (Number, Number)
			//
			("别", new BinaryFunction<double,double>((x,y) => x)),

			//Function "所", Binary (Number, Number)
			//
			("所", new BinaryFunction<double,double>((x,y) => x)),

			//Function "话", Binary (Number, Number)
			//
			("话", new BinaryFunction<double,double>((x,y) => x)),

			//Function "小", Binary (Number, Number)
			//
			("小", new BinaryFunction<double,double>((x,y) => x)),

			//Function "自", Binary (Number, Number)
			//
			("自", new BinaryFunction<double,double>((x,y) => x)),

			//Function "回", Binary (Number, Number)
			//
			("回", new BinaryFunction<double,double>((x,y) => x)),

			//Function "然", Binary (Number, Number)
			//
			("然", new BinaryFunction<double,double>((x,y) => x)),

			//Function "果", Binary (Number, Number)
			//
			("果", new BinaryFunction<double,double>((x,y) => x)),

			//Function "发", Binary (Number, Number)
			//
			("发", new BinaryFunction<double,double>((x,y) => x)),

			//Function "见", Binary (Number, Number)
			//
			("见", new BinaryFunction<double,double>((x,y) => x)),

			//Function "心", Binary (Number, Number)
			//
			("心", new BinaryFunction<double,double>((x,y) => x)),

			//Function "走", Binary (Number, Number)
			//
			("走", new BinaryFunction<double,double>((x,y) => x)),

			//Function "定", Binary (Number, Number)
			//
			("定", new BinaryFunction<double,double>((x,y) => x)),

			//Function "听", Binary (Number, Number)
			//
			("听", new BinaryFunction<double,double>((x,y) => x)),

			//Function "觉", Binary (Number, Number)
			//
			("觉", new BinaryFunction<double,double>((x,y) => x)),

			//Function "太", Binary (Number, Number)
			//
            ...
            //Function "呢", Unary (String) -> List[Number]
            //To char array
